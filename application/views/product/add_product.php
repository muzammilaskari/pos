  ...
  <ol class="breadcrumb"><li class="active">Dashboard</li></ol>
    ...
    <div class="main-header clearfix">
        <div class="page-title">
            <h3 class="no-margin">Add Product</h3>
    ...
    <div class="costom-border-line">
       ...
       <input type="text" placeholder="Product Name" required id="product_name" name="product_name" class="form-control">
        </div><!--end of col-->
        <div class="col-md-6">
        <label class="">Quantity</label>
       <input type="text" placeholder="Product Quantity" required id="quantity" name="quantity" class="form-control">
        </div><!--end of col-->
        ...
        <div class="row">
        <div class="col-md-6">
        <label class="">Price &pound;</label>
       <input type="text" placeholder="Price" required id="price" name="price" class="form-control">
        </div><!--end of col-->
        <div class="col-md-6">
        <label class="">Reorder Level</label>
       <input type="text" placeholder="Reorder Level" required id="reorder_level" name="reorder_level" class="form-control">
        </div><!--end of col-->
        ...
        <div class="col-md-6">
            ...
            <input type="text" placeholder="code" required id="barcode" name="barcode" class="form-control">
        </div>
