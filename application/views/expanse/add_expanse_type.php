  ...
  <ol class="breadcrumb"><li class="active">Dashboard</li></ol>
    ...
    <div class="main-header clearfix">
        <div class="page-title">
            <h3 class="no-margin">Add Expense Type</h3>
    ...
    <div class="costom-border-line">
        <form action="<?php echo SURL?>manage_expense/add_expanse_type_process" enctype="multipart/form-data" method="post" id="frm_add" >
        <!-- /.row -->
        <div class="costom-forem">
        <div class="row">
        <div class="col-md-6">
        <label class="">Expense Type</label>
       <input type="text" placeholder="Expense Type" required value="" id="expense_title" name="expense_title" class="form-control">
        </div><!--end of col-->
        <div class="col-md-6">
       ...
       <textarea rows="5" class="form-control" required name="expense_note"></textarea>
        </div><!--end of col-->
