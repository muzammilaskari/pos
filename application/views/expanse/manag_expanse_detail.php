            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Expense Detail Management</strong>
						<hr>
                        <div class="col-md-1">
           <a href="<?php echo base_url();?>manage_expense/add_expanse_detail" class="btn btn-success btn-sm bounceIn animation-delay5 "><i class="fa fa-sign-in"></i> Add Expense Detail</a>
           </div>
           <div class="col-md-3">
        ...
        <!--<button class="btn btn-success btn-sm bounceIn animation-delay5 " id="submit" type="submit" name="submit" value="submit" ><i class="fa fa-sign-in"></i> Add</button>-->
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="responce_res">
                            <?php if(isset($all_expense_detail) && (count($all_expense_detail) > 0)){$count = 1;
									foreach($all_expense_detail as $res){	
							?>
                            <tr>
                                <td><?php echo $count;?></td>
                                <td><?php foreach($all_type as $type){ if($res['type_id'] == $type['id']){?>
								<?php echo $type['expense_title']; ?>
								<?php } }?></td>
                                <td><?php echo $res['expense_amount']; ?></td>
                                <td>
                                	<?php if($res['status']==1){?>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu slidedown">
                                        <li><a href="<?php echo base_url();?>manage_expense/edit_expanse_detail/<?php echo $res['id']; ?>">Edit</a></li>
                                        <li><a onclick="return del_rec();" href="<?php echo base_url();?>manage_expense/delete_expanse_detail/<?php echo $res['id']; ?>">Delete</a></li>
