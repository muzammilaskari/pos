                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Add Supplier</h3>
											 <br>
...
<form action="<?php echo SURL?>users/add_supplier_process" enctype="multipart/form-data" method="post" id="frm_add" >
