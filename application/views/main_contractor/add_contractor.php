                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Add Main Contractor</h3>
											 <br>
...
<form action="<?php echo SURL?>users/add_contractor_process" enctype="multipart/form-data" method="post" id="frm_add">
            ...
            <div class="clear20"></div>
                ...
                <div class="row form-group">
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        ...
                        <input type="text" placeholder="Firm Name" required id="firm_name" name="firm_name" class="form-control" required="required">
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        <label>Info</label>
                        <input type="text" placeholder="Info" required id="info" name="info" class="form-control" required="required">
                    </div>
                     <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                         <label>Street</label>
