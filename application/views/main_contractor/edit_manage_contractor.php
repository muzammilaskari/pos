     ...
     <tbody>
        ...
        ?>       
         ...
         <tr>
          ...
          <td>
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_contacts/<?php echo $ints['id']; ?>/<?php echo 1; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
                </td>
                 </tr>
