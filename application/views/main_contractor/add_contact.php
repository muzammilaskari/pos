                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border pfc-grid-color-1">
                                        ...
                                        <div class="ssm_home_dashboard">
                                        	<form action="<?php echo SURL?>users/add_contractor_contact_process" enctype="multipart/form-data" method="post" id="frm_add" >
                                                        ...
                                                        <div class="clear20"></div>
															...
															<div class="row form-group">
																...
																<div class="col-md-6 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" name="firm_name" id="firm_name" placeholder="Firm" class="form-control" value="<?php echo $contact->firm_name;?>" readonly="readonly">
