                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Manage Main Contractor</h3>
											 <br>
											<div class="row">
...
{   
?>                                                
					<a class="btn btn-default" href="<?php echo SURL?>users/add_contractor">Add Main Contractor</a>
<?php
}  
?>
												</div>
           ...
           <input type="text" required="required" placeholder="Search..." id="search_news1" class="form-control"> 
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
			...
			<td> <a href="<?php echo SURL;?>users/edit_manage_contractor/<?php echo $int['id']; ?>"><?php echo $int['firm_name']; ?></a></td>
            <td><?php echo $int['email_address']; ?></td>
            <td><?php echo $int['street'].'.'.$int['second_street'].','.$int['city'].','.$int['country']; ?></td>
             <td><?php echo $int['firm_type']; ?></td>
...
{   
?>            
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_contractor/<?php echo $int['id']; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
<?php
}   
?>
<?php
...
{   
?>  
                <a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo SURL; ?>users/delete_contractor/<?php echo $int['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="delete the data"></i></a>
<?php
}  
?>
<?php
if($this->session->userdata('user_type')==1)
{   if($int['firm_type']=='firm'){
?>  
               
                 <a class="btn btn-default" href="<?php echo SURL; ?>users/add_contact_main/<?php echo $int['id']; ?>"><i class="fa fa-plus-square" aria-hidden="true" title="Add Contact"></i></a>
<?php
}  }
?>
...
?>  
                ...
                <a class="btn btn-default" title="View Detail"  href="<?php echo SURL;?>users/edit_manage_contractor/<?php echo $int['id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
<?php
 }
?>
            </td>  
