                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Manage Project</h3>
											 <br>
											<div class="row">
...
?>
           ...
           <?php if(!empty($project)){ ?>                                                <div class="table-responsive">
<div id="newsResult">
...
{   
?>            
                <a class="btn btn-default" title="View Detail" href="<?php echo SURL; ?>project/detail_project/<?php echo $int['id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
<?php
 }  
?>
