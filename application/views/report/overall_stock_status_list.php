            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <strong>Overall Stock Status </strong>
						<hr>
                        <a target="_blank" href="<?php echo base_url();?>manage_report/pdf_overall_assign_stock_status_tables" class="btn btn-success btn-sm bounceIn animation-delay5 "><i class="fa fa-sign-in"></i> Print </a>
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach($all_product as $product){?>
                        	<tr>
                                ...
                                <?php if(isset($all_assign_product) && (count($all_assign_product)>0)){?>
                                	<?php $res_quntity = $product['quantity'];?>
                                	<?php foreach($all_assign_product as $assign_qun ){?>
                                    	<?php if($assign_qun['product_id'] == $product['id']){?>
                                        	<?php $res_quntity = $assign_qun['SUM(`quantity`)'] + $product['quantity'];?>
                                        <?php break;}?>
                                    <?php }?>
								<td><?php echo $res_quntity;?></td>
                                <?php }else{?>
