...
$(document).ready(function(){
  ...
  product_roc();
	...
	function product_roc(){
		...
		var s_id = $('#shop_list').val();
		var s_date = $("#datepicker").val();
		var e_date = $("#datepicker1").val();
		$("#print_hrf").attr("href", "<?php echo SURL; ?>manage_report/pdf_expense_shop_reorder_table/"+s_id+"/"+s_date+"/"+e_date)
		//alert(s_date);
		$.ajax({

                type: "POST",

                url: "<?php echo SURL; ?>manage_report/expense_shop_reorder_process/",

                data: {s_id: s_id,s_date: s_date,e_date: e_date},
