            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <strong>Shop Stock Status </strong>
						<hr>
                        <div class="row">
...
$(document).ready(function(){
  ...
  product_roc();
	...
	function res_print(){
		...
		$("#print_hrf").attr("href", "<?php echo SURL; ?>manage_report/pdf_shop_stock_report_table/"+p_id);
	...
	function product_roc(){
		...
		$.ajax({
                ...
                url: "<?php echo SURL; ?>manage_report/shop_stock_report/",
