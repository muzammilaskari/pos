			...
			<div class="col-md-12">
				<div class="grid simple ">
					<div class="grid-body no-border pfc-grid-color-1">
						<h3 class="text-center heading_color">Add Catalog</h3>
						<br>			 
						<div class="panel-collapse" id="">	
							<div class="ssm_home_dashboard">
								<form action="<?php echo SURL?>catalog/add_catalog_process" enctype="multipart/form-data" method="post" id="frm_add">
									<div class="row">
										<div class="col-md-12">
										<div class="switch_board_main">
											<div class="clear20"></div>
												<div class="row form-group">
													<div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
														<label>Company</label>
														<input type="text" placeholder="Company" name="company_name" class="form-control" required="required">
													</div>
													<div class="col-md-6 col-sm-12 col-xs-12">
														<label>Name</label>
														<input type="text" placeholder="Name" name="catalog_name" class="form-control" required="required">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
											...
											<div class="clear20"></div>
											<input type="submit" id="button" value="Add Catalog" class="btn btn-default pull-left custom-marg" />
