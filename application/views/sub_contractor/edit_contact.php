                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border pfc-grid-color-1">
                                        ...
                                        <div class="ssm_home_dashboard">
                                        	<form action="<?php echo SURL?>users/add_subcontractor_contact_process" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
...
{   
?>            
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_contacts_sub/<?php echo $int['id']; ?>/<?php echo '0' ;?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
<?php
}   
?>
<?php
