...
<?php 
	...
	echo '<tr>';
echo '<td><center><h3>NO Contacts Added</h3></center></td>';
echo '</tr>';
}
...
?>
        ...
        <tr>
			...
			<td>street</td>
            <td><?php echo $ints['street']; ?></td>
            
           </tr>
            <tr>
			
			<td>second_street</td>
            <td><?php echo $ints['second_street']; ?></td>
            
           </tr>
             <tr>
			
			<td>country</td>
            <td><?php echo $ints['country']; ?></td>
            
           </tr>
             <tr>
			
			<td>city</td>
            <td><?php echo $ints['city']; ?></td>
          ...
          <td>
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_contacts_sub/<?php echo $ints['id']; ?>/<?php echo 1; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
                </td>
