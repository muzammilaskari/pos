...
{   
?>                                                
					<a class="btn btn-default" href="<?php echo SURL?>users/add_subcontractor">Add Sub Contractor</a>
<?php
}  
?>
												</div>
           ...
           <input type="text" required="required" placeholder="Search..." id="search_news2" class="form-control"> 
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
			...
			<td><a href="<?php echo SURL;?>users/edit_manage_subcontractor/<?php echo $int['id']; ?>"><?php echo $int['firm_name']; ?></a></td>
...
{   
?>            
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_subcontractor/<?php echo $int['id']; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
<?php
}   
?>
<?php
...
{   
?>  
                <a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo SURL; ?>users/delete_subcontractor/<?php echo $int['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="delete the data"></i></a>
<?php
}  
?>
<?php
if($this->session->userdata('user_type')==1)
{  if($int['firm_type']!='individual'){ 
?>  
               
                 <a class="btn btn-default" href="<?php echo SURL; ?>users/add_subcontact/<?php echo $int['id']; ?>"><i class="fa fa-plus-square" aria-hidden="true" title="Add Contact"></i></a>
<?php
}}  
?>
            </td>
