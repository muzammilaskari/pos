                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Update Main Contractor</h3>
											 <br>
...
<form action="<?php echo SURL?>users/update_subcontractor_process" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
        ...
        <div class="switch_board_main">
            <div class="clear20"></div>
                ...
                <div class="row form-group">
                    ...
                    <input type="text" placeholder="First Name" value="<?php echo $user['firm_name'] ?>" required id="firm_name" name="firm_name" class="form-control">
                    <input type="hidden"  value="<?php echo $user['id'] ?>"  name="id" class="form-control" />
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      <label>Email</label>
                        <input type="text" placeholder="Email" value="<?php echo $user['email_address'] ?>" required id="email_address" name="email_address" readonly="readonly" class="form-control">
                    </div>
                </div>
