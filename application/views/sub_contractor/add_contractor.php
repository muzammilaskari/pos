                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Add Sub Contractor</h3>
											 <br>
...
<form action="<?php echo SURL?>users/add_subcontractor_process" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
				...
				<label>Select Firm Type</label>
                 <div class="row form-group">
                     <div class="col-md-1">
                         ...
                         <input type="radio" id="firm" placeholder="Country" name="firm_type" class="form-control" value="Firm"  checked="checked">
             
                    </div>
                    <div class="col-md-1">
                       
                         <input type="radio" id="individual" placeholder="Country" name="firm_type" class="form-control" value="Individual" >
                    </div>
                </div>        
