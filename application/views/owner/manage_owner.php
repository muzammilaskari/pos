                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Manage Owner</h3>
											 <br>
											<div class="row">
...
{   
?>                                                
					<a class="btn btn-default" href="<?php echo SURL?>users/add_owner">Add Owner</a>
<?php
}  
?>
												</div>
            ...
            <input type="text" required="required" placeholder="Search..." id="search_news4" name="search" class="form-control"> 
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
		...
		<td> <a href="<?php echo SURL;?>users/edit_manage_owner/<?php echo $int['id']; ?>"><?php echo $int['firm_name']; ?></a></td>
...
{   
?>            
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_owner/<?php echo $int['id']; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
<?php
}   
?>
<?php
...
{   
?>  
                <a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo SURL; ?>users/delete_owner/<?php echo $int['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="delete the data"></i></a>
<?php
}  
?>
<?php
...
?>  
                 ...
                 <a class="btn btn-default" href="<?php echo SURL; ?>users/add_owners/<?php echo $int['id']; ?>"><i class="fa fa-plus-square" aria-hidden="true" title="Add Contact"></i></a>
<?php
}  }
?>   
<?php
...
{   
?>  
                <a class="btn btn-default" title="View Detail"  href="<?php echo SURL;?>users/edit_manage_owner/<?php echo $int['id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
<?php
}  
?>
