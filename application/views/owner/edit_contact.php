                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border pfc-grid-color-1">
                                        ...
                                        <div class="ssm_home_dashboard">
                                        	<form action="<?php echo SURL?>users/add_owner_contact_process" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
...
{   
?>            
                <a class="btn btn-default" href="<?php echo SURL; ?>users/edit_owner_contacts/<?php echo $int['id']; ?>/<?php echo '0'; ?>"><i class="fa fa-pencil" aria-hidden="true" title="edit the data"></i></a>
<?php
}   
?>
<?php
...
{   
?>  
                <a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo SURL; ?>users/delete_owner_contact/<?php echo $int['id']; ?>/<?php echo $int['firm_id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="delete the data"></i></a>
