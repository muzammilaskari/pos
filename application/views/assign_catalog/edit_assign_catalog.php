 ...
 <style>
  ...
  <div class="page-content">
    ...
    <div class="content sm-gutter">
     ...
     <form action="<?php echo SURL?>catalog/edit_assign_catalog" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
											 ...
											 <div class="col-md-12 col-sm-12 col-xs-12">
												...
												<div class="row form-group">
                                                    ...
                                                    <label>Main Firms</label>
                                                        ...
                                                        <option selected="selected"  value="Interior Designe" <?php  if($get_catalog[0]['firm_name']=='interior design'){echo 'selected';}?>>Interior Design</option>
                                                        <option value="Main Contractor" <?php  if($get_catalog[0]['firm_name']=='main contractor'){echo 'selected';}?>>Main Contractor</option>
                                                        <option value="Owner" <?php  if($get_catalog[0]['firm_name']=='owner'){echo 'selected';}?>>Owner</option>
                                                        <option value="Supplier" <?php  if($get_catalog[0]['firm_name']=='supplier'){echo 'selected';}?>>Supplier</option>
                                                        </select>
