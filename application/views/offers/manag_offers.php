            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
						...
						<hr>
                        <div class="col-md-1">
           <a href="<?php echo base_url();?>manage_offers/add_offers" class="btn btn-success btn-sm bounceIn animation-delay5 "><i class="fa fa-sign-in"></i>Add Offer</a>
           </div>
        ...
        <!--<button class="btn btn-success btn-sm bounceIn animation-delay5 " id="submit" type="submit" name="submit" value="submit" ><i class="fa fa-sign-in"></i> Add</button>-->
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id="responce_res">
                            <?php if(isset($all_offers) && (count($all_offers) > 0)){$count = 1;
									foreach($all_offers as $res){	
							?>
                            <tr>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu slidedown">
                                        ...
                                        <li><a href="<?php echo base_url();?>manage_offers/view_offers/<?php echo $res['id'];?>">View</a></li>
                                        <li><a onclick="return del_rec();" href="<?php echo base_url();?>manage_offers/delete_offer/<?php echo $res['id']; ?>">Delete</a></li>
