                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Update Interior Design</h3>
											 <br>
...
<form action="<?php echo SURL?>users/update_interior_process" enctype="multipart/form-data" method="post" id="frm_add" novalidate="novalidate">
