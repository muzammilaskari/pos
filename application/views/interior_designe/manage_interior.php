                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Manage Interior Design</h3>
											 <br>
											<div class="row">
...
?>
            ...
            <input type="text" required="required" placeholder="Search..." id="search_news" class="form-control"> 
...
{   
?>  
                <a class="btn btn-danger"  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo SURL; ?>users/delete_interior/<?php echo $int['id']; ?>"><i class="fa fa-trash" aria-hidden="true" title="delete the data"></i></a>
...
?>  
                 ...
                 <a class="btn btn-default" href="<?php echo SURL; ?>users/add_contacts/<?php echo $int['id']; ?>"><i class="fa fa-plus-square" aria-hidden="true" title="Add Contact"></i></a>
<?php
}}  
?>
<?php
...
?>  
                 ...
                 <a class="btn btn-default" title="View Product detail"  href="<?php echo SURL;?>users/edit_manage_interior/<?php echo $int['id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
<?php
}  
?>
