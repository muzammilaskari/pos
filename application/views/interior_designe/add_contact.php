  ...
  <div class="page-content">
    ...
    <div class="content sm-gutter">
      ...
      <div class="row">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border pfc-grid-color-1">
                                        ...
                                        <div class="ssm_home_dashboard">
                                        	<form action="<?php echo SURL?>users/add_interior_contact_process" enctype="multipart/form-data" method="post" id="frm_add" >
                                                        ...
                                                        <div class="clear20"></div>
															...
															<div class="row form-group">
																...
																<div class="col-md-6 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" name="firm_name" id="firm_name" placeholder="Firm" class="form-control" value="<?php  echo $contact[0]['firm_name'];?>" required="required" readonly="readonly">
                                                                    
                                                                     <input type="hidden" id="firm_id" name="firm_id" placeholder="Customer" class="form-control" value="<?php echo $contact[0]['id'];?>">
                                                                </div>
															
																<div class="col-md-6 col-sm-12 col-xs-12">
                                                                <label>Employee Name</label>
                                                                    <input type="text" id="employee_name" name="employee_name[]" placeholder="Customer" class="form-control" required="required">
                        ...
                        <input type="email" placeholder="Email" required id="email_address" name="email_address[]" class="form-control" required="required">
                                                                </div>
                                                                <!--<div class="col-md-6 col-sm-12 col-xs-12">
                                                                 <label>Street</label>
                        ...
                        <input type="text" placeholder="Second Street" name="second_street[]" id="second_street" class="form-control" required="required">
                                                                </div>
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <label>Country</label>
                        <input type="text" placeholder="Country" name="country[]" id="country" class="form-control" required="required">
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                                    <label>City</label>
                        <input type="text" placeholder="City" name="city[]" id="city" class="form-control" required="required">
                                                                </div>
                                                            </div>-->
