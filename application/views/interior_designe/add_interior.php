                            ...
                            <div class="col-md-12">
                                ...
                                <div class="grid simple ">
                                    ...
                                    <div class="grid-body no-border">
											 ...
											 <h3 class="text-center heading_color">Add Interior Design</h3>
											 <br>
...
<form action="<?php echo SURL?>users/add_interior_design_process" enctype="multipart/form-data" method="post" id="frm_add" >
    ...
    <div class="row">
        ...
        <div class="switch_board_main">
            <div class="clear20"></div>
                ...
                <div class="row form-group">
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        ...
                        <input type="text" placeholder="Firm Name" required="required" id="firm_name" name="firm_name" class="form-control">
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        <label>Email Address</label>
                        <input type="email" placeholder="Email" required="required" id="email_address" name="email_address" class="form-control">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        <label>Info</label>
                        <input type="text" placeholder="Info" required="required" id="info" name="info" class="form-control">
                    </div>
                     <div class="col-md-6 col-sm-12 col-xs-12 contact_field_margin">
                        <label>Street</label>
            ...
            <a href="<?php echo SURL;?>users/manage_interior" class="btn btn-danger pull-left custom-marg">Cancel</a>
            <!--   <a href="<?php echo SURL;?>users/add_interior_contact" class="btn btn-default pull-left custom-marg">Add Contacts</a>-->
