					...
					<div class="grid-body no-border pfc-grid-color-1">
						...
						<div class="panel-collapse" id="">	
							<div class="ssm_home_dashboard">
								<form action="<?php echo SURL?>product/add_assign_sample" enctype="multipart/form-data" method="post" id="frm_add">
									<div class="row">
										<div class="col-md-12">
							...
							<input type="text" placeholder="Quantity" required="required" name="quantity" class="form-control">
                            <input type="hidden"  name="size_id" value="<?php echo $id;?>" class="form-control">
