...
<style>.panel.panel-default .panel-heading {padding-bottom: 54px;}</style>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <hr>
                    <form method="post" action="<?php echo SURL?>check_in_out/check_in_out_history">
                        <div class="col-md-3">
                                    ...
                                    <tbody>
                                        <?php if(isset($user_data) && (count($user_data) > 0)){$count = 1;
                                         ...
                                         <tr>
                                            ...
                                            <td><?php echo ucfirst($res['check_in_time']); ?></td>
                                            <td><?php echo $res['check_out_time']; ?></td>
