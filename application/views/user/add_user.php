...
<div id="wrapper" class="preload">
  ...
  <div class="main-header clearfix">
    <div class="page-title">
        <h3 class="no-margin">Add User</h3>
                                    ...
                                    <div class="costom-forem">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" placeholder="User Name" required name="user_name" class="form-control">
                                            </div><!--end of col-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" placeholder="Salary Per Hour" required id="salary_per_hour" name="salary_per_hour" class="form-control">
